...
* ✅ Proporcionar y aceptar retroalimentación constructiva
...
* ❌ Conducta discriminatoria de cualquier tipo

## Valores del Proyecto

Como proyecto cristiano, también valoramos:

* 🙏 **Amor y Respeto**: Tratar a todos con amor y respeto (Mateo 22:39)
* 🤝 **Unidad**: Trabajar juntos en armonía (Salmos 133:1)
* 💪 **Servicio**: Servir a otros con humildad (Marcos 10:45)
* ✨ **Excelencia**: Hacer todo con excelencia para la gloria de Dios (Colosenses 3:23)
* 🌱 **Crecimiento**: Apoyar el crecimiento personal y espiritual de todos
...
Todas las quejas serán revisadas e investigadas y resultarán en una respuesta que se considere necesaria y apropiada a las circunstancias. El equipo del proyecto está obligado a mantener confidencialidad con respecto al reportero de un incidente.

### Proceso de Aplicación

1. **Reporte**: Envía un reporte detallado del incidente
2. **Revisión**: El equipo revisará el reporte en 48 horas
3. **Investigación**: Se investigará el incidente de manera justa e imparcial
4. **Acción**: Se tomará la acción apropiada según la severidad
5. **Seguimiento**: Se hará seguimiento con el reportero

### Consecuencias

Las consecuencias por violar el código de conducta pueden incluir:

1. **Advertencia**: Una advertencia privada del equipo
2. **Advertencia Temporal**: Prohibición temporal de contribuir
3. **Prohibición Permanente**: Prohibición permanente del proyecto
...
Contacta a los mantenedores del proyecto en rootmontesion@gmail.com

### ¿Qué pasa si no estoy de acuerdo con una decisión?

Puedes apelar la decisión enviando un email explicando tu caso. El equipo revisará la apelación.

### ¿Este código aplica a todas las comunicaciones?

Sí, aplica a todas las interacciones relacionadas con el proyecto, incluyendo GitHub, emails, chat y eventos.
...
¡Gracias por ayudarnos a mantener una comunidad acogedora y respetuosa! 🙏✨
