...
/* -------------------- UI -------------------- */
const inputClass =
  "w-full rounded-2xl bg-white/5 border border-white/10 px-4 py-3 text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-emerald-500"
  ...
  return (
    <div className="space-y-5">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-3.5 md:space-y-4">
          ...
          <a href="/login" className="text-[11px] text-emerald-300 underline block text-center">
